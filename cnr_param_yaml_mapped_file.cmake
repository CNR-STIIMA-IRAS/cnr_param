...
# ##############################################################################
list(APPEND YAML_MAPPED_FILE_DEPENDENCIES_INCLUDE_DIRS ${yaml-cpp_INCLUDE_DIRS}
  ${Boost_INCLUDE_DIRS} ${EIGEN3_INCLUDE_DIRS})
list(APPEND YAML_MAPPED_FILE_BUILD_INTERFACE_INCLUDE_DIRS
  ${YAML_MAPPED_FILE_DEPENDENCIES_INCLUDE_DIRS}
  ${CMAKE_CURRENT_SOURCE_DIR}/include)
list(APPEND YAML_MAPPED_FILE_INSTALL_INTERFACE_INCLUDE_DIRS
  ${YAML_MAPPED_FILE_DEPENDENCIES_INCLUDE_DIRS} include)

set(SRC_DIR ${CMAKE_CURRENT_SOURCE_DIR}/src/${PROJECT_NAME}/yaml_mapped_file)
list(APPEND cnr_param_yaml_mapped_file_SRC ${SRC_DIR}/interprocess.cpp
  ${SRC_DIR}/yaml.cpp)

add_library(cnr_param_yaml_mapped_file SHARED ${cnr_param_yaml_mapped_file_SRC})
target_include_directories(
  cnr_param_yaml_mapped_file
  PUBLIC
...
target_link_libraries(
  ...
  PUBLIC Eigen3::Eigen)
add_library(cnr_param::cnr_param_yaml_mapped_file ALIAS
      cnr_param_yaml_mapped_file)
...
target_link_libraries(
  cnr_param_server_utilities
  PUBLIC cnr_param_yaml_mapped_file Boost::program_options Boost::iostreams
...
if(ENABLE_TESTING)
  ...
  add_executable(
    cnr_param_yaml_mapped_file_test
    ${SRC_DIR}/args_parser.cpp ${SRC_DIR}/yaml_manager.cpp
  ...
  target_link_libraries(cnr_param_yaml_mapped_file_test cnr_param_yaml_mapped_file GTest::Main)
    ...
    if(CMAKE_THREAD_LIBS_INIT)
      target_link_libraries(cnr_param_yaml_mapped_file_test
        "${CMAKE_THREAD_LIBS_INIT}")
    endif()
  endif()

  target_compile_definitions(cnr_param_yaml_mapped_file_test
