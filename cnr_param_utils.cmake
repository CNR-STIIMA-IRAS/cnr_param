...
list(APPEND cnr_param_utils_SRC
    ${SRC_DIR}/colors.cpp
      ${SRC_DIR}/filesystem.cpp
          ${SRC_DIR}/string.cpp
              ${INCLUDE_DIR}/eigen.h)

add_library(cnr_param_utils SHARED ${cnr_param_utils_SRC} )
target_include_directories(cnr_param_utils PUBLIC
  "$<BUILD_INTERFACE:${UTILS_BUILD_INTERFACE_INCLUDE_DIRS}>"
    "$<INSTALL_INTERFACE:${UTILS_INSTALL_INTERFACE_INCLUDE_DIRS}>")

target_link_libraries(cnr_param_utils 
  PUBLIC yaml-cpp
  PUBLIC Boost::system
...
list(APPEND TARGETS_LIST cnr_param_utils)
###################################
## END - UTILS Build             ##
###################################
