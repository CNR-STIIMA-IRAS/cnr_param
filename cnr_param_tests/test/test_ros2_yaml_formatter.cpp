...
TEST(Ros2YamlDecoderTest, SequenceOfSequenceNode)
{
  ...
  // Call the function being tested
  YAML::Node result = cnr::param::ros2::ros2_yaml_decoder(node);
...
TEST(Ros2YamlDecoderTest, SequenceOfComplexTypesNode)
{
  ...
  // Call the function being tested
  YAML::Node encoded = cnr::param::ros2::ros2_yaml_encoder(node);

  YAML::Node result = cnr::param::ros2::ros2_yaml_decoder(encoded);
